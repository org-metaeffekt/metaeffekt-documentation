...
| Associated License - Canonical Name<br>SPDX ID / Expression                             | immediate/<br>secondary/<br>atomic | Possible effective Licenses                                                                                                                                                                                                                                                      |
|-----------------------------------------------------------------------------------------|------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| BSD 3-Clause License<br><sub>`BSD-3-Clause`</sub>                                       | no/no/yes                          | - BSD 3-Clause License                                                                                                                                                                                                                                                                      |
