...
| <sub>Atomic</sub>                     | <sub>Associated license consists of a license (potentially with modifiers); based on the modifiers several different licenses can be concluded</sub> |
