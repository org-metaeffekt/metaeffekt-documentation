...
This concept has the advantage that the key joins, which can get very large and inefficient with increasing table data, don't have to be
built every time the view is accessed. This increases the speed when querying views.
